...
const targetElement = document.querySelector('div[data-file="scheduler/feature/ProTaskEditExtraItems.js"] .external-target');
...
const project = new bryntum.scheduler.ProProjectModel({
...
const panel = new bryntum.scheduler.ProScheduler({

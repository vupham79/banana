...
(function () {
  ...
  var scheduler = new Scheduler({
    ...
    resourceImagePath: window.location.host.includes('bryntum') && !window.location.host.includes('.localhost') ? '/examples/scheduler/_shared/images/users/' : '../examples/_shared/images/users/',
    columns: [{
      type: 'resourceInfo',
      field: 'name',
      text: 'Name'

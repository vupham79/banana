...
(function () {
  var targetElement = document.querySelector('div[data-file="scheduler/feature/ProTaskEditExtraItems.js"] .external-target'); // User may already have navigated away from the documentation part that shows the example

  if (!targetElement) return;
  targetElement.innerHTML = ''; //START
  // Project contains all the data and is responsible for correct scheduling

  var project = new bryntum.scheduler.ProProjectModel({
  ...
  var panel = new bryntum.scheduler.ProScheduler({

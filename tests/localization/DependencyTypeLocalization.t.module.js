import { ProjectModel, PredecessorsTab, LocaleManager, DependencyField, DependencyTypePicker } from '../../build/gantt.module.js?437987';
...
StartTest(t => {
    ...
    t.it('Should localize dependency type in PredecessorsTab', async(t) => {
        ...
        Object.keys(window.bryntum.locales).forEach(name => {
            const
                ...
                dependencyTypes = locale.SchedulerProCommon.dependencyTypesLong;
    ...
    t.it('Should localize dependency type in DependencyField', async(t) => {
        ...
        Object.keys(window.bryntum.locales).forEach(name => {
            const
                locale   = applyLocale(t, name),
                depNames = locale.SchedulerProCommon.dependencyTypes;

...
StartTest(function (t) {
  ...
  t.it('Should export visible rows (scrolled)',
  /*#__PURE__*/
  function () {
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        assertContentMultipage = function _ref7(doc, i) {
                          var _gantt2 = gantt,
                          ...
                          var _t$getDateRangeFromEx = t.getDateRangeFromExportedPage(doc),
                            ...
                            return DateHelper.intersectSpans(startDate, endDate, r.startDate, r.endDate) && taskStore.indexOf(r) > 4 && taskStore.indexOf(r) < 14;
                          });
                        ...
                        assertContent = function _ref6(doc) {
                          ...
                          var events = taskStore.query(function (r) {
                            return gantt.timeAxis.isTimeSpanInAxis(r) && taskStore.indexOf(r) > 4 && taskStore.indexOf(r) < 14;
                          });
                        ...
                        _doExport = function _ref5() {
                          ...
                          /*#__PURE__*/
                          regeneratorRuntime.mark(function _callee(rowsRange, exporterType, totalPages, callback) {
                                ...
                                switch (_context2.prev = _context2.next) {
                                  case 0:
                                    ...
                                    return gantt.features.pdfExport.export({
                                      columns: gantt.columns.getRange().map(function (r) {
                                        return r.id;
                                      }),

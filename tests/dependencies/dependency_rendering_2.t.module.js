import { ProjectGenerator, BrowserHelper } from '../../build/gantt.module.js?437987';
...
StartTest(t => {
    ...
    t.snooze('2020-01-31'/*'Should avoid forced reflow during refresh'*/, t => {
        gantt = t.getGantt({
            enableEventAnimations : false,
            tasks                 : [
        ...
        function setupOverrides() {
            let feature              = gantt.features.dependencies,

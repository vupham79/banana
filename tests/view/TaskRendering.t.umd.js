...
StartTest(function (t) {
  ...
  t.it('Tasks that starts/ends outside timeaxis should render correctly',
  /*#__PURE__*/
  function () {
    var _ref25 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee24(t) {
      var tickWidth;
  ...
  t.it('should use taskRenderer', function (t) {
    gantt = t.getGantt({
      taskRenderer: function taskRenderer(_ref26) {
        var taskRecord = _ref26.taskRecord;
  ...
  t.it('should work with taskRenderer returning DOM config', function (t) {
    gantt = t.getGantt({
      taskRenderer: function taskRenderer(_ref27) {
        var taskRecord = _ref27.taskRecord;
        return {
          tag: 'b',

import { Toolbar, Toast, DateHelper, CSSHelper, PercentDoneColumn, ColumnStore, ResourceAssignmentColumn, Column, TaskModel, Gantt, Panel, ProjectModel, EffectResolutionResult, WidgetHelper } from '../../build/gantt.module.js?437987';
...
const gantt = new Gantt({
    ...
    columns : [
        ...
        { type : 'calendar' },
        { type : 'constrainttype' },
        { type : 'constraintdate', format : 'll LT' },
        { type : 'statuscolumn' },
        {
            type  : 'date',
            text  : 'Deadline',

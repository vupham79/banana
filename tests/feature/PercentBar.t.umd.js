...
StartTest(function (t) {
  ...
  t.it('Should be possible to resize percent bar to 100% of the task width',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should not show resize handle if Gantt is readOnly',
  /*#__PURE__*/
  function () {
  ...
  t.it('Percent bar drag should not affect the task duration',
  /*#__PURE__*/
  function () {

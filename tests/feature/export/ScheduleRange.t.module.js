import { AjaxHelper, DateHelper, Override, ProjectGenerator, RandomGenerator, Gantt, PresetManager, PaperFormat, RowsRange, ScheduleRange, Rectangle } from '../../../build/gantt.module.js?437987';
        ...
        t.chain(
            ...
            async() => {
                async function doExport(scheduleRange, exporterType, totalPages, callback) {
                    ...
                    let { html } = result.response.request.body;
                ...
                function assertContent(doc) {
                    ...
                    t.is(gotVisibleRange.startDate, gantt.timeAxis.roundDate(expectedVisibleRange.startDate), 'Exported start date is ok');

...
(function () {
  ...
  targetElement.innerHTML = '<p>This example shows a custom Task Editor configuration. The built-in "Notes" tab is hidden, a custom "Files" tab is added, the "General" tab is renamed to "Common" and a custom text field is appended to it. Double-click on a task bar to start editing:</p>'; //START

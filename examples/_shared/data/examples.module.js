...
var examples = [
    ...
    { folder : 'angular/advanced', group : 'Integration', title : 'Angular Advanced demo', version : 'Angular 7', build : true },
    { folder : 'angular/taskeditor', group : 'Integration', title : 'Task editor customization Angular demo', version : 'Angular 7', build : true, since : '1.0.2' },
    { folder : 'angular/pdf-export', group : 'Integration', title : 'Angular PDF/PNG export demo (offline)', version : 'Angular 8', buile : true, since : '2.0', offline : true },
    ...
    { folder : 'react/javascript/advanced', group : 'Integration', title : 'React Advanced demo', version : 'React 16', build : true },
    { folder : 'react/javascript/basic', group : 'Integration', title : 'React Basic demo', version : 'React 16', build : true, since : '1.1.2', updated : '1.3' },
    { folder : 'react/javascript/pdf-export', group : 'Integration', title : 'React PDF/PNG export demo (offline)', version : 'React 16', build : true, since : '2.0', offline : true },
    { folder : 'react/typescript/basic', group : 'Integration', title : 'React Basic demo with TypeScript', version : 'React 16', build : true, since : '1.1.3' },
    ...
    { folder : 'vue/javascript/advanced', group : 'Integration', title : 'Vue Advanced demo', version : 'Vue 2', build : true },
    { folder : 'vue/javascript/pdf-export', group : 'Integration', title : 'Vue PDF/PNG export demo (offline)', version : 'Vue 2', build : true, since : '2.0', offline : true },

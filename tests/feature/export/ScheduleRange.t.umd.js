...
StartTest(function (t) {
  ...
  t.it('Should export visible schedule',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee3(t) {
      var horizontalPages, _ref2;
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        assertContent = function _ref6(doc) {
                          var _gantt = gantt,
                              ...
                              expectedVisibleRange = gantt.getVisibleDateRange(),
                              gotVisibleRange = t.getDateRangeFromExportedPage(doc),
                          ...
                          var events = taskStore.query(function (r) {
                            return gantt.timeAxis.isTimeSpanInAxis(r) && taskStore.indexOf(r) < 9;
                          });
                          ...
                          t.is(gotVisibleRange.startDate, gantt.timeAxis.roundDate(expectedVisibleRange.startDate), 'Exported start date is ok'); // Use floor for end because last tick is partially visible

                          t.is(gotVisibleRange.endDate, gantt.timeAxis.floorDate(expectedVisibleRange.endDate), 'Exported end date is ok');
                        };

                        _doExport = function _ref5() {
                          _doExport = _asyncToGenerator(
                          /*#__PURE__*/
                          regeneratorRuntime.mark(function _callee(scheduleRange, exporterType, totalPages, callback) {
                            var result, html, _loop, i;
                        ...
                        doExport = function _ref4(_x2, _x3, _x4, _x5) {
                          return _doExport.apply(this, arguments);
                        };

...
Class('BryntumGanttTest', {
  ...
  BryntumGanttData],
  methods: {
    waitForPropagate: function waitForPropagate(partOfProject, next) {
      var async;
      return regeneratorRuntime.async(function waitForPropagate$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return regeneratorRuntime.awrap(partOfProject.waitForPropagateCompleted());
    ...
    createGanttForExport: function createGanttForExport() {
      ...
      return regeneratorRuntime.async(function createGanttForExport$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _ref2 = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {}, _ref2$verticalPages = _ref2.verticalPages, verticalPages = _ref2$verticalPages === void 0 ? 1 : _ref2$verticalPages, _ref2$horizontalPages = _ref2.horizontalPages, horizontalPages = _ref2$horizontalPages === void 0 ? 1 : _ref2$horizontalPages, _ref2$rowHeight = _ref2.rowHeight, rowHeight = _ref2$rowHeight === void 0 ? 50 : _ref2$rowHeight, _ref2$rowsPerPage = _ref2.rowsPerPage, rowsPerPage = _ref2$rowsPerPage === void 0 ? 11 : _ref2$rowsPerPage, _ref2$height = _ref2.height, height = _ref2$height === void 0 ? 450 : _ref2$height, _ref2$width = _ref2.width, width = _ref2$width === void 0 ? 600 : _ref2$width, _ref2$startDate = _ref2.startDate, startDate = _ref2$startDate === void 0 ? new this.global.Date(2018, 11, 31) : _ref2$startDate, _ref2$endDate = _ref2.endDate, endDate = _ref2$endDate === void 0 ? new this.global.Date(2019, 0, 28) : _ref2$endDate, _ref2$featuresConfig = _ref2.featuresConfig, featuresConfig = _ref2$featuresConfig === void 0 ? {} : _ref2$featuresConfig;
              timelineWeight = 0.75;
              ...
              _context2.next = 8;
              return regeneratorRuntime.awrap(this.global.ProjectGenerator.generateAsync(verticalPages * (rowsPerPage - 1), rowsPerPage - 1, function () {}));

            case 8:
              _ref3 = _context2.sent;
              tasksData = _ref3.tasksData;
              dependenciesData = _ref3.dependenciesData;
    ...
    assertExportedGanttDependenciesList: function assertExportedGanttDependenciesList(doc) {
      ...
      function getToSide(doc, dependency) {
        ...
        if (dependency.toSide) {
          ...
          var from = dependency.fromEvent,
              ...
              fromIndex = doc.querySelector(".b-timeline-subgrid [data-id=\"".concat(from.id, "\"]")).dataset.index,
              to = dependency.toEvent,
              toTime = to.startDate.getTime(),
              toIndex = doc.querySelector(".b-timeline-subgrid [data-id=\"".concat(to.id, "\"]")).dataset.index;
      ...
      function getPointFromBox(doc, record, side, arrowMargin) {
        var point,
            ...
            adjustRight = 0,
            adjustTop = 0,
            el = doc.querySelector("[data-task-id=\"".concat(record.id, "\"]")),
      ...
      dependencies.forEach(function (dep) {
        ...
        if (from && to) {
          ...
          if (dependencyEl) {
            if (fromPoint && toPoint) {
              ...
              if (fromPoint) {
                if (Math.abs(depFromPoint[0] - fromPoint[0]) > threshold) {
                  _this.fail("Dependency ".concat(dep.id, " start point x is ok"), {
                    got: depFromPoint[0],
                    need: fromPoint[0]
                  });
                ...
                if (Math.abs(depFromPoint[1] - fromPoint[1]) > threshold) {
                  _this.fail("Dependency ".concat(dep.id, " start point y is ok"), {
                    got: depFromPoint[1],
                    need: fromPoint[1]
                  });
              ...
              if (toPoint) {
                if (Math.abs(depToPoint[0] - toPoint[0]) > threshold) {
                  _this.fail("Dependency ".concat(dep.id, " end point x is ok"), {
                    got: depToPoint[0],
                    need: toPoint[0]
                  });
                ...
                if (Math.abs(depToPoint[1] - toPoint[1]) > threshold) {
                  _this.fail("Dependency ".concat(dep.id, " end point y is ok"), {
                    got: depToPoint[1],
                    need: toPoint[1]
                  });
            ...
            _this.fail("Element is not found for dependency ".concat(dep.id));
    ...
    assertExportedTasksList: function assertExportedTasksList(t, doc) {
      var _this2 = this;
      ...
      tasks.forEach(function (task) {
        ...
        if (!taskElement) {
          t.fail("Element is not found for task ".concat(task.name || task.id));
          pass = false;
        } else {
          var rectangle = _this2.global.Rectangle,
          ...
          if (rowBox.intersect(taskBox).height !== taskBox.height) {
            t.fail("Task ".concat(task.id, " is not aligned to row"), {
              got: taskBox,
              need: rowBox,

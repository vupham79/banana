 ...
 * @Last Modified time: 2019-05-01 19:50:13
 *
...
<template>
    <div id="app">
        <demo-header title="Vue PDF/PNG export demo"></demo-header>
...
<script>
    ...
    import Gantt from 'bryntum-vue-shared/src/Gantt.vue';
    ...
    export default {
        ...
        methods : {
            ...
            exportHandler() {
                this.$refs.gantt.ganttEngine.features.pdfExport.showExportDialog();
            }
        },

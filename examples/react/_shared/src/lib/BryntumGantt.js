...
// we import gantt.umd for IE11 compatibility only. If you don't use IE
...
class BryntumGantt extends Component {
    ...
    render() {
        return <div className={'b-react-gantt-container'} ref={el => this.el = el}>{this.state.portals}</div>;
    } // eo function render

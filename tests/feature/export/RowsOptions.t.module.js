import { AjaxHelper, DateHelper, Override, ProjectGenerator, RandomGenerator, Gantt, PresetManager, PaperFormat, RowsRange, Rectangle } from '../../../build/gantt.module.js?437987';
            ...
            async() => {
                async function doExport(rowsRange, exporterType, totalPages, callback) {
                    const result = await gantt.features.pdfExport.export({
                        columns : gantt.columns.getRange().map(r => r.id),
                        exporterType,
                        rowsRange
                    });
                ...
                let topRecord = gantt.taskStore.getById(5);
